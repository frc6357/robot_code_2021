...
public class Robot extends TimedRobot {
  ...
  // Solenoid corresponds to a double solenoid.
  private final DoubleSolenoid m_doubleSolenoid2 = new DoubleSolenoid(2,0);

  // DoubleSolenoid corresponds to a double solenoid.
  private final DoubleSolenoid m_doubleSolenoid = new DoubleSolenoid(3,1);

  private final WPI_VictorSRX m_victorSRX; 
