...
def cubicSplineSegment(xs_input, ys_input, start_angle_deg, end_angle_deg):
    ...
    ax.plot(xs_input, ys_input, 'o', label="Endpoints")
    # TODO: endpoints are rotated and transformed, even if the inital inputs are passed in
...
cubicSplineSegment(np.array([11, 15]), np.array([4, 10]), 60, 45)
