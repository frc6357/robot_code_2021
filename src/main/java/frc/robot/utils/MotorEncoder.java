...
//
// This is a wrapper class used to make the Falcom500 (TalonFX) CAN encoders provide the outputs
// we need to drive the Ramsete controller used for path following during autonomous mode.
//
